...
local config  = require("config.config")  --当前app配置
local cookie_middleware =  require("lor.lib.middleware.cookie")  --cookie开启 
local uploader_middleware = require("logic.app.middleware.uploader") --文件上传开启
local login_middleware = require("logic.app.middleware.login") --登陆页面验证 与 url 白名单
...
local auth_router = require("logic.app.routes.auth")   
local user_router = require("logic.app.routes.user")
local upload_router = require("logic.app.routes.upload") 
local push_router = require("logic.app.routes.push")
local group_router = require("logic.app.routes.group")
