...
local stringy = require("app.libs.stringy")
local _M = {}
...
function _M.os_execute(command, preserve_output)
    local n = os.tmpname() -- 得到一个临时文件名存储输出
    local f = os.tmpname() -- 得到一个临时文件名存储脚本
